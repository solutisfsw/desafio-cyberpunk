...
<a href="#" class="log_btn">Adicionar Clone</a>
</div>
...
<h3>O NOME JÁ EXISTE NO NOSSO REGISTRO, ESCOLHA OUTRO<span></span></h3>
<form id="contact" method="post" action="clonesControlador?action=cad">
<label><input type="hidden" name="idClone" value="${clones.idClone}" ></label>
<label>O Nome do seu Clone segue o seguinte registro: AAA-9999
<input type="text" style='text-transform:uppercase' name="nome" value=""  class="nome" id="nome"required></label>
<label>Habilidade:<select name="skill" required>
...
<label>Idade:<select name="idade" required>
...
<label>Gênero:<select name="genero" required>
  <option value="Homem" >Homem</option>
  <option value="Mulher" >Mulher</option>
  <option value="Transsexual" >Transsexual</option>
   <option value="Não Definido" >Não quero</option>
</select> </label>
<label>Habilidade Especial:<select name="especial" required>
...
<a><center><button class="btn btn-success" type="submit">Criar Conta</button></center></a>
</form>
</div>
</div>
